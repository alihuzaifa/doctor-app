...
const PatientProfile = ({navigation}) => {
  ...
  const formik = useFormik({
    initialValues: patientProfileInitialValues,
    validationSchema: patientProfileInitialSchema,
    onSubmit: async values => {
      ...
      // http://drapp.somee.com/api/tblPatients/2
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: '#fff'}}>
      {/* <Header placement="right" rightComponent={<CustomMenu />} /> */}
      {isConnected ? (
        <>
          ...
          <ScrollView
            ...
            {formik.errors.patientName && formik.touched.patientName ? (
              <Text style={STYLES.error}>{formik.errors.patientName}</Text>
            ) : null}
            <View style={STYLES.inputContainer}>
              ...
              <TextInput
                id="patientEmail"
                name="patientEmail"
                onChangeText={formik.handleChange('patientEmail')}
                onBlur={formik.handleBlur('patientEmail')}
            ...
            {formik.errors.patientEmail && formik.touched.patientEmail ? (
              <Text style={STYLES.error}>{formik.errors.patientEmail}</Text>
            ) : null}
            <View style={STYLES.inputContainer}>
              <Icon
                name="phone"
              ...
              <TextInput
                id="patientPhone"
                name="patientPhone"
                onChangeText={formik.handleChange('patientPhone')}
                onBlur={formik.handleBlur('patientPhone')}
            ...
            {formik.errors.patientPhone && formik.touched.patientPhone ? (
              <Text style={STYLES.error}>{formik.errors.patientPhone}</Text>
            ) : null}
            <View style={STYLES.inputContainer}>
              <Icon
                name="local-hospital"
            ...
            <View style={STYLES.inputContainer}>
              ...
              <TextInput
                ...
                onChangeText={formik.handleChange('patientPassword')}
                onBlur={formik.handleBlur('patientPassword')}
                value={formik.values.patientPassword}
                placeholder="Password"
                style={STYLES.input}
                placeholderTextColor={COLORS.light}
              />
            </View>
            {formik.errors.patientPassword && formik.touched.patientPassword ? (
              <Text style={STYLES.error}>{formik.errors.patientPassword}</Text>
            ) : null}
            <TouchableOpacity
              style={{
